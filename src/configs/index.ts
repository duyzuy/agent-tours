const config = {
  ...
  LOCAL_API_URL: process.env.NODE_ENV === "production" ? "https://tours.frdev.asia/api" : "http://localhost:3000/api",
...
export const mediaConfig = {
  ...
  rootPath: "/uploads",
  rootApiPath: `${
    process.env.NODE_ENV === "production" ? "https://tours.frdev.asia/api/uploads" : "http://localhost:3000/api/uploads"
  }`,
  rootFolder: "uploads",
  maxfileSize: 2, //mb 2,
