...
const FlagAF: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...rest }) => {
  return (
    <svg
    ...
    >
      ...
      <g fill="#fff" fillRule="evenodd" stroke="#bd6b00" strokeWidth=".5" transform="translate(2.2 86.8)scale(.84611)">
