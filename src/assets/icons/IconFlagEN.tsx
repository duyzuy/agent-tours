...
const IconFlagEN: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...rest }) => {
    return (
        <svg width="200" height="120" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...rest}>
            <g clipPath="url(#clip0_857_109205)">
                <path d="M0 0H200V120H0V0Z" fill="#012169" />
                <path d="M23.3125 0.00019919L0.000212352 0.000198089L0.000212848 14.0024L176.69 120.001L200 120.001L200 105.997L23.3125 0.00019919Z" fill="white" />
                <path d="M200 14.0025L200 0.000272264L176.688 0.000266495L0.000207768 105.997L0.000206565 120.001L23.3104 120.001L200 14.0025Z" fill="white" />
