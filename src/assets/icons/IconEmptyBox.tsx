...
const IconEmptyBox: React.FC<React.SVGProps<SVGSVGElement>> = ({
    className,
    ...rest
}) => {
    return (
        ...
        >
            ...
            <g id="Empty_Box" data-name="Empty Box">
                ...
                />
                <path
                    d="m40.89 42.55-8.89 4.45v-22l10-5v20.76a2 2 0 0 1 -1.11 1.79z"
                    fill="url(#linear-gradient-5)"
                />
                <path
                    d="m32 25-2.76 7.35a1 1 0 0 1 -.93.65h-24.87a1 1 0 0 1 -.93-1.35l2.49-6.65z"
                    fill="#8ad3fe"
                />
                <path
                ...
                />
                <path
                    d="m11 38h-2a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2z"
                    fill="#f0f7fc"
                />
            </g>
        </svg>
