...
const ModalLanguageList: React.FC<ModalLanguageListProps> = ({
    items,
    onCancel,
    open = false,
    onAdd,
                        ...
                        {items.map((lc, _index) => (
                            <div
                                className={classNames(
                                    "border rounded-sm px-3 py-3 cursor-pointer",
                                    {
                                        "mt-3": _index !== 0,
                                        " bg-blue-50 border-primary-default":
                                            selectingItem?.key === lc.key,
                                    },
                                )}
                                key={lc.key}
