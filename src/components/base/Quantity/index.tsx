...
const Quantity: React.FC<QuantityProps> = ({
  ...
  return (
    <span className={classNames("quantity__control")}>
      <span
        className={classNames("quantity__control-btn inline-flex items-center justify-center cursor-pointer", {
      ...
      <span
        className={classNames("quantity__control-value inline-flex items-center justify-center", {
          "w-18 h-10": size === "lg",
          "w-16 h-8": size === "md",
          "w-14 h-6": size === "sm",
        })}
