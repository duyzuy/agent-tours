...
export const ButtonPrimaryDangerOutlineStyled = styled(Button)`
  & {
    color: red;
    border-color: red;
  }
...
export const ButtonPrimarySuccessOutlineStyled = styled(Button)`
  & {
    color: #08a89c;
    border-color: #b6f5fe;
  ...
  &.travel-btn-default:not(:disabled):not(.travel-btn-disabled).travel-btn-background-ghost:hover {
    border-color: #b6f5fe;
    color: #08a89c;
  }
...
export const ButtonSecondary: React.FC<CustomButtonProps> = ({
  children,
  buttonProps,
  className = "",
  color = "grey",
...
export const ButtonPrimary: React.FC<CustomButtonProps> = ({
  children,
  buttonProps,
  className = "",
  color = "grey",
