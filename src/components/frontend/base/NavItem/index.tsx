...
const NavItem = ({
    ...
    return (
        ...
        >
            ...
            >
                {href ? (
                    <NavLink prefix={prefix} href={href} title={title} />
                ) : (
                    <span>{title}</span>
                )}
...
NavItem.Dropdown = function NavItemDropdown({
    className = "",
    items,
}: NavItemDropdown) {
    return (
        <div
            className={classNames(
                "rounded-lg bg-white shadow-lg ring-1 ring-gray-900/5 w-80 absolute z-100",
                {
                    [className]: className,
                },
            )}
