...
export interface IVisaTemplateContent {
    ...
    includeAndNotes: IVisatemplateContentMetaData | null;
    itineraries: IVisatemplateContentMetaData | null;
    slug: string;
    lang: LangCode;
    languages: {
        lang: LangCode;
...
export interface VisaTemplateContentListResponse
    extends BaseResponse<IVisaTemplateContent[]> {}

export interface VisaTemplateContentMetaDataResponse
    extends BaseResponse<IVisatemplateContentMetaData> {}
