...
export class DisCountQueryParams {
  ...
  constructor(
    ...
    (this.requestObject = requestObject), (this.pageCurrent = pageCurrent), (this.pageSize = pageSize);
  }
}

export interface IDiscountPolicyListRs extends BaseResponse<IDiscountPolicy[]> {}
