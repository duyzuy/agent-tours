...
export interface RuleAndPolicyCatListRs extends BaseResponse<IRuleAndPolicyCat[]> {}
export interface RuleAndPolicyRuleListRs extends BaseResponse<IRuleAndPolicyRule[]> {}
