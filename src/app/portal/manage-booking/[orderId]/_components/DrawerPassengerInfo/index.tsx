...
type TKeysPassenger = KeysOfValue<
    Required<BookingOrderPassengerFormData>,
    string
>;
type Pasenger = Required<BookingOrderPassengerFormData>;

const DrawerPassengerInfo: React.FC<DrawerPassengerInfoProps> = ({
    isOpen,
    onClose,
    onSubmit,
    initialValues,
                    ...
                    <Col span={12}>
                        ...
                        >
                            <Select
                                ...
                                onChange={(value) =>
                                    onChangeFormData("paxTitle", value)
                                }
                            />
                        </FormItem>
                    </Col>
                    <Col span={12}>
                        ...
                        >
                            <Select
                                ...
                                onChange={(value) =>
                                    onChangeFormData("paxGender", value)
                                }
                            />
                        </FormItem>
                    </Col>
                    ...
                    <Col span={12}>
                        ...
                        >
                            <DatePicker
                                ...
                                value={
                                    dayjs(
                                        passengerFormData.paxBirthDate,
                                        DATE_FORMAT,
                                    ).isValid()
                                        ? dayjs(
                                              passengerFormData.paxBirthDate,
                    ...
                    <Col span={8}>
                        ...
                        >
                            <DatePicker
                                ...
                                value={
                                    dayjs(
                                        passengerFormData.paxPassortExpiredDate,
                                        DATE_FORMAT,
                                    ).isValid()
                                        ? dayjs(
                                              passengerFormData.paxPassortExpiredDate,
