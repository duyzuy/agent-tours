...
export const sellableConfirmSchema: ObjectSchema<SellableConfirmFormData> =
    object({
...
export const priceConfigSchema: ObjectSchema<SellablePriceConfigPayload> =
    object({
        ...
        configs: array()
            .of(
                object({
                    ...
                    maxAvaiable: number().required(
                        "maxAvailable không bỏ trống",
                    ),
