...
const PageCreate = () => {
  ...
  const onWatchingFormChange = useCallback<Required<ContentPageFormProps>["onWatchFormChange"]>((formData) => {
    if (
      isEqualObject(
        [
          "id",
  ...
  return (
    <PageContainer
      ...
      breadCrumItems={[{ title: "Trang nội dung", href: "/portal/contents/page" }, { title: "Thêm mới" }]}
    >
      <LocaleContainer
