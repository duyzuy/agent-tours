...
const PassengerForm: React.FC<PassengerFormProps> = ({
  ...
  return (
    <div
      className={classNames("passenger-form", {
        [className]: className,
      })}
    >
      <div className="passenger-form__head mb-3 pb-3">
          ...
          <Col span={12}>
            ...
            >
              <CustomDatePicker
                ...
                className="w-full"
                value={
                  initialValues?.paxBirthDate ? dayjs(initialValues?.paxBirthDate, { format: DATE_FORMAT }) : undefined
                }
