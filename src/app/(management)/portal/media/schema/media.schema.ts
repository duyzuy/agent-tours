...
export const mediaFolderUpdateSchema: ObjectSchema<MediaFolderUpdateFormData> =
    object({
...
export const mediaFolderCreateSchema: ObjectSchema<MediaFolderCreateFormData> =
    object({
        folderName: string()
            .required("Tên thư mục không để trống.")
            .matches(
