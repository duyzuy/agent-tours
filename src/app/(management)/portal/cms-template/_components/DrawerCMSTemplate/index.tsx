...
const DrawerCMSTemplate: React.FC<DrawerCMSTemplateProps> = ({
    ...
    const initFormData = new CMSTemplateFormData("", "", undefined, "", [
    ...
    const onChangeFormData = (
        key: keyof CMSTemplateFormData,
        value: CMSTemplateFormData[keyof CMSTemplateFormData],
    ) => {
    ...
    const onChangeTemplateFormContent: Required<FormContentTemplateByLangProps>["onChangeForm"] =
        useCallback((lang, data) => {
            setFormData((oldData) => {
                const { templates } = oldData;
                let newTemplates = [...templates];
                const indexItem = templates.findIndex(
                    (item) => item.lang === lang,
                );
    ...
    const getContentByLang = (lang: LangCode) =>
        formData.templates.find((item) => item.lang === lang);
        ...
        setFormData(() => {
            return action === "edit"
                ? {
                      ...
                      templates:
                          initialValue?.templates.reduce<
                              CMSTemplateFormData["templates"]
                          >((acc, item) => {
                              return [
                                  ...acc,
                                  {
            ...
            <Form layout="vertical">
                ...
                >
                    <Input
                        ...
                        onChange={(ev) =>
                            onChangeFormData("codeName", ev.target.value)
                        }
                    />
                </FormItem>
                <FormItem
...
function FormContentTemplateByLang({
    lang,
    onChangeForm,
    values,
    disabled,
