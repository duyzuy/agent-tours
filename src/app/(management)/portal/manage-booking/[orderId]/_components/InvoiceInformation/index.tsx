...
const InvoiceInformation: React.FC<InvoiceInformationProps> = ({ orderId, invoiceInfo, className = "", onSave }) => {
        ...
        <Row gutter={16}>
          <Col span={12} className="mb-3">
            <div className="">
              ...
              <span className="font-[500]">{invoiceInfo?.invoiceName || "--"}</span>
            </div>
          </Col>
          <Col span={12} className="mb-3">
            <div className="">
              <span className="block text-xs">Email</span>
              <span className="font-[500]">{invoiceInfo?.invoiceEmail || "--"}</span>
            </div>
          </Col>
          <Col span={12} className="mb-3">
            <div className="">
              <span className="block text-xs">Tên công ty</span>
              <span className="font-[500]">{invoiceInfo?.invoiceCompanyName || "--"}</span>
            </div>
          </Col>
          <Col span={12} className="mb-3">
            <div className="">
              <span className="block text-xs">Mã số thuế</span>
              <span className="font-[500]">{invoiceInfo?.invoiceTaxCode || "--"}</span>
            </div>
          </Col>
          <Col span={12} className="mb-3">
            <div className="">
              <span className="block text-xs">Địa chỉ</span>
              <span className="font-[500]">{invoiceInfo?.invoiceAddress || "--"}</span>
            </div>
          </Col>
        </Row>
      </div>
