...
const CustomerInformationForm: React.FC<CustomerInformationFormProps> = ({ onChangeForm, value, errors }) => {
  ...
  return (
    <div className="customer__information-form max-w-2xl mt-6">
      <div className="customer__information-form-head py-3">
        <span className="font-[500] text-[16px]">Thông tin người đặt mới</span>
      </div>
      <div className="customer__information-form-body">
        <Form layout="vertical" component="div">
          <Row gutter={16}>
            ...
            <Col span={24}>
              <FormItem label="Khách hàng ghi chú" validateStatus={errors?.rmk ? "error" : ""} help={errors?.rmk || ""}>
                <Input.TextArea
                  value={value?.rmk}
                  placeholder="Ghi chú"
