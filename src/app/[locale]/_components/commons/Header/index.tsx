...
const Header = () => {
    return (
        <header className="bg-white drop-shadow-sm">
            <nav
                className="mx-auto flex max-w-7xl items-center justify-between py-4 container"
                aria-label="Global"
            >
                <div className="flex lg:flex-1">
                    <Logo alt="Logo An Thai" width={80} height={80} />
                </div>
                    ...
                    <div className="bottom-menu flex items-center">
                        <ul className="flex items-center">
                            <li className="relative px-3 py-2">
                                <span
                                    className="flex items-center gap-x-1 font-semibold leading-6 text-main-400"
                                    aria-expanded="false"
                                >
                                    Tra cứu Booking
                                    <svg
