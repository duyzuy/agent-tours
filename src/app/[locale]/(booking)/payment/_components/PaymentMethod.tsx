    ...
    <div className="lg:px-6 px-3 pb-6">
      ...
      <PaymentMethodItem
        ...
        bodyContent={
          <>
            <p className="mb-3">
              Quý khách vui lòng thực hiện chuyển khoản với nội dung kèm họ, tên, mã đơn hàng, chúng tôi sẽ kiểm tra và
              tiến hành xác nhận đơn hàng sau khi nhận thành công.
            </p>
