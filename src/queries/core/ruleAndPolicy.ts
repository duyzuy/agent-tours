...
export const useGetRuleAndPolicyDepositCatListCoreQuery = (options?: { enabled?: boolean }) => {
  return useQuery({
...
export const useGetRuleAndPolicyDepositRuleListCoreQuery = (options?: { enabled?: boolean }) => {
  return useQuery({
...
export const useGetRuleAndPolicyLimitTimeCatListCoreQuery = (options?: { enabled?: boolean }) => {
  return useQuery({
...
export const useGetRuleAndPolicyLimitTimeRuleListCoreQuery = (options?: { enabled?: boolean }) => {
  return useQuery({
...
export const useGetRuleAndPolicyPenaltyRuleListCoreQuery = (options?: { enabled?: boolean }) => {
  return useQuery({
...
export const useGetRuleAndPolicyPenaltyCatListCoreQuery = (options?: { enabled?: boolean }) => {
  return useQuery({
