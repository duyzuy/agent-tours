...
const ProfileExtraInformationForm: React.FC<ProfileExtraInformationFormProps> = ({ data }) => {
  ...
  const isDisableButton = useMemo(() => {
    return (
      ...
      isEqual(formData.infoLegalRepresentative, data?.infoLegalRepresentative) &&
              ...
              <Col span={12}>
                <FormItem label="Công ty">
                  <Input
                    ...
                    onChange={(evt) => onChange("infoCompanyName", evt.target.value)}
                  />
                </FormItem>
              </Col>
              <Col span={12}>
                <FormItem label="Mã số thuế">
                  <Input
                    ...
                    onChange={(evt) => onChange("infoTaxcode", evt.target.value)}
                  />
                </FormItem>
              </Col>
              <Col span={12}>
                <FormItem label="Chức danh">
                  <Input
                    ...
                    onChange={(evt) => onChange("infoPosition", evt.target.value)}
                  />
                </FormItem>
              </Col>
              <Col span={12}>
                <FormItem label="Người đại diện">
                  <Input
                    ...
                    onChange={(evt) => onChange("infoLegalRepresentative", evt.target.value)}
                  />
                </FormItem>
              </Col>
              <Col span={12}>
                <FormItem label="Địa chỉ">
                  <Input
                    ...
                    onChange={(evt) => onChange("infoAddress", evt.target.value)}
                  />
                </FormItem>
              </Col>
              <Col span={12}>
                <FormItem label="Thông tin ngân hàng">
                  <Input
                    ...
                    onChange={(evt) => onChange("infoBanking", evt.target.value)}
                  />
                </FormItem>
              </Col>
              <Col span={24}>
                <FormItem label="Ghi chú">
                  <Input.TextArea
                    ...
                    onChange={(evt) => onChange("infoSpecialNote", evt.target.value)}
                  />
                </FormItem>
              </Col>
              <Col span={24}>
