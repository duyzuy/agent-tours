...
!(function () {
  ...
  const ps = (e, t, o, n) => {
      ...
      ((e, t) => L(e, (e) => Ce(e, t)))(e, r).bind((e) =>
        ((e, t, o) =>
          ...
          ((e, t) =>
            ht(e, "table").bind((o) =>
              wt(o, t).bind((t) =>
                xs(t, e).bind((e) => e.boxes.map((t) => ({ boxes: t, start: e.start, finish: e.finish }))),
              ),
            ))(e, n),
        ),
      ),
    ...
    Es = (e, t, o) =>
      t.length <= 1
        ? C.none()
        : Ds(e, o.firstSelectedSelector, o.lastSelectedSelector).map((e) => ({ bounds: e, cells: t })),
        ...
        l = (t, o) => {
          const n = ((e, t) => {
              const o = pt(e, t).getOrThunk(() => {
                ...
                return (
                  "thead" === t ? wl(e, "caption,colgroup", o) : "colgroup" === t ? wl(e, "caption", o) : Ie(e, o), o
                );
              });
              return Ve(o), o;
            })(e, o),
    ...
    Za = Rl(
      ...
      (e, t) =>
        qt(t.element).bind((o) => Sl(e, o).map((e) => ({ ...e, generators: t.generators, clipboard: t.clipboard }))),
      Ea,
      f,
      da,
    ),
                          ...
                          return s.fold(
                            () =>
                              Ss(t, n.firstSelectedSelector, n.lastSelectedSelector).map((e) => {
                                ...
                                return (
                                  r.setRelativeSelection(ei.on(e.first, 0), o(e.table)), n.clear(t), ti(C.none(), !0)
                                );
                              }),
