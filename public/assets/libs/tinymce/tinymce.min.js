...
!(function () {
  ...
  const jo = (e) => (t) => !!t && t.nodeType === e,
    ...
    fs = (e, t) =>
      ...
      ((e) =>
        $o(e) && "A" === e.nodeName && !e.hasAttribute("href") && (e.hasAttribute("name") || e.hasAttribute("id")))(
        e,
      ) ||
      gs(e),
  ...
  const Mi = (e, t) => {
    ...
    Hi = (e) =>
      e ? Te(e.childNodes, (e, t) => (Ui(t) && "BR" !== t.nodeName ? (e = e.concat(Hi(t))) : e.push(t), e), []) : [],
    $i = (e) => (t) => e === t,
    qi = (e) =>
    ...
    Yi = (e, t, n) => {
      let o = 0;
      return (
        Dt.each(e.select(t), (e) => ("all" === e.getAttribute("data-mce-bogus") ? void 0 : e !== n && void o++)), o
      );
    },
    Xi = (e, t) => {
  ...
  const Zc = ir,
    ...
    Ru = (e, t) =>
      Cu(e).fold(L, (e) => (t.setStart(e.container(), e.offset()), t.setEnd(e.container(), e.offset()), !0)),
    Au = (e, t, n) =>
      !(
        !((e) => !e.hasChildNodes())(t) ||
        !ku(e, t) ||
  ...
  const uf = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
    ...
    Bf = (e) => {
      ...
      if (t === o && Jo(t)) {
        ...
        (Jo(t) && n > 0 && n < t.data.length && ((t = Tf(t, n)), (n = 0)), Jo(o) && r > 0 && r < o.data.length)
      ) {
        const e = Tf(o, r).previousSibling;
        (o = e), (r = e.data.length);
      }
  ...
  const Jg = ["font", "text-decoration", "text-emphasis"],
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome()
            ...
            : I.none()).orThunk(() => (n && (o.each((e) => Yp(e.dom, e.dom.length)), r.each((e) => Gp(e.dom, 0))), t))
        );
        var s, a, i, l;
    ...
    yh = (e, t, n, o = !0) => {
      ...
      if (
        (a.dom === e.getBody() ? hh(e, o) : bs(a) && (Pr(a), o && e.selection.setCursorLocation(a.dom, 0)), !En(n, a))
      ) {
        const e = Pt(An(a), n)
          ? []
          : An((i = a))
                  ...
                  gu(n, e.getBody(), r).fold(
                    ...
                    (s) =>
                      ((e, t, n, o) =>
                        yu(e.dom)
                          .bind((r) =>
                            Cu(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r))),
                          )
                          .getOr(!0))(o, n, r, s)
                        ? ((e, t) => jh(e, t))(e, o)
                        : ((e, t, n) =>
    ...
    xb = (e, t, n) =>
      !(!km(n) || !yb(t, n.inline)) || !(!wm(n) || !yb(t, n.block)) || (!!xm(n) && $o(t) && e.is(t, n.selector)),
    kb = (e, t, n, o, r, s) => {
      const a = n[o],
        i = "attributes" === o;
  ...
  const jb = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
    Hb = (e, t) => {
      const n = e.get(t);
      return p(n)
        ? J(n, (e) => km(e) && "span" === e.inline && ((e) => f(e.styles) && $(me(e.styles), (e) => H(jb, e)))(e))
        : I.none();
    },
    ...
    pv = (e, t, n, o) =>
      gv(e, t, n, o, o).fold(N(o), (t) => (e.dom.createFragment().appendChild(o), e.dom.rename(o, t)), N(null)),
    hv = (e, t, n, o, r) => {
  ...
  const Gy = (e, t, n, o) => {
    ...
    Yy = (e, t, n, o, r) =>
      !(o in Vy && $y(e, r, n)) && (!e.validate || t.isValid(n, o) || He(o, "data-") || He(o, "aria-")),
    ...
    LC = (e) => ({
        ...
        closest: (t) =>
          ((e, t) => {
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                vb(yn(o), (n) => ue(t, (t) => ((t, n) => (Eb(e, t.dom, n) ? I.some(n) : I.none()))(n, t)), n),
              )
              .getOrNull();
          })(e, t),
      ...
      editor: {
        getContent: (t) =>
          ((e, t) => I.from(e.getBody()).fold(N("tree" === t.format ? new Fg("body", 11) : ""), (n) => Kg(e, t, n)))(
            e,
            t,
          ),
        setContent: (t, n) =>
    ...
    qC = (e, t, n, o) => {
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) => ((e, t, n) => FC(e).selection.getContent(t, n))(e, t.format ? t.format : "html", t))(o, e),
          setContent: i,
  ...
  const Ek = (e, t, n, o, r, s) => {
    ...
    dE = (e, t) =>
      (e || "table" === Ht(t) ? "margin" : "padding") + ("rtl" === lo(t, "direction") ? "-right" : "-left"),
    cE = (e) => {
      const t = mE(e);
      return (
        !e.mode.isReadOnly() &&
    ...
    zE =
      ...
      () =>
        e.apply(null, t),
    jE = (e, t) =>
      J(((e, t) => te(((e) => q(e, (e) => ({ ...FE, ...e })))(e), (e) => (UE(e, t) ? [e] : [])))(e, t), (e) =>
        e.action(),
      ),
    HE = (e, t) =>
      ue(((e, t) => te(((e) => q(e, (e) => ({ ...FE, ...e })))(e), (e) => (UE(e, t) ? [e] : [])))(e, t), (e) =>
        e.action(),
      ),
    $E = (e, t) => {
      const n = t ? Jc.Forwards : Jc.Backwards,
    ...
    fS = (e, t) => {
      ...
      return ((e, t) =>
        ((e, t, n = L) =>
          n(t) ? I.none() : H(e, Ht(t)) ? I.some(t) : Zn(t, e.join(","), (e) => xn(e, "table") || n(e)))(
          ["td", "th"],
          e,
          t,
        ...
        xe(o, e).fold(
          ...
          (e) =>
            ((e, t, n, o) =>
              xe(n, o).fold(
                () =>
                  ((e, t, n) => PS(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + DS(t)))(
                    e,
                    n,
                    o,
                  ),
      ...
      switch (e.tag) {
        case "required":
          return ((e, t, n, o) =>
            xe(t, n).fold(
              () =>
                ((e, t, n) => PS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + DS(n)))(
                  e,
                  n,
                  t,
                ),
    ...
    c_ = (e, t, n) =>
      l_(
        ...
        ((e) => {
          return (
            (t = (t) =>
              H(e, t) ? sl.value(t) : sl.error(`Unsupported value: "${t}", choose one of "${e.join(", ")}".`)),
            jS((e) => t(e).fold(TS, OS))
          );
          var t;
        })(n),
        ...
        : n
          ? ((e, t) =>
              t.startSummary.exists((t) =>
                ((e, t) =>
                  Cu(t).exists((n) => (rr(n.getNode()) && vu(t, n).exists((t) => t.isEqual(e))) || n.isEqual(e)))(e, t),
              ))(s, t) ||
        ...
        if (/^(LI|DT|DD)$/.test(r) && $o(s) && i.isEmpty(S))
          return void ((e, t, n, o, r) => {
            ...
            if (dN(n, o, !0) && dN(n, o, !1))
              ...
              aN(n, "LI")
                ? (s.insertAfter(d, lN(n)), d.appendChild(s.doc.createTextNode(" ")), d.appendChild(n))
                : i.insertBefore(d, n),
                s.remove(o);
  ...
  const iR = ti("mode"),
    ...
    FR = (e, t, n, o, r) => {
      ...
      if (!s.cancelled) {
        ...
        r
          ? Y_(e, "insertFromPaste", { dataTransfer: IR(t) }).isDefaultPrevented() || (n(), G_(e, "insertFromPaste"))
          : n();
      }
    },
    UR = (e, t, n, o) => {
  ...
  const uA = (e, t) => Math.abs(e.left - t),
    ...
    MA = (e) => {
      ...
      const l = (e) => e !== o && (PA(e) || cr(e)) && n.isChildOf(e, o) && n.isEditable(e.parentNode),
        ...
        f = (r, c) => {
          ...
          const g = r.endOffset;
          if (
            (Jo(m) && 0 === f && PA(m.parentNode) && ((m = m.parentNode), (f = n.nodeIndex(m)), (m = m.parentNode)),
            !$o(m))
          )
            return null;
    ...
    eO = (e, t, n, o) => {
      ...
      return vS(i, l - n.pattern.end.length, t).bind((d) => {
        ...
        if (JA(a)) return I.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
        {
          ...
          return m.map((e) => {
            const t = ((e, t, n, o = !1) => UA(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(
              r,
              s,
              e,
              o,
    ...
    hO = (e) => {
      ...
      (o.disabled = !0),
        ...
        !e.readonly &&
          e.hasEditableRoot() &&
          (e.inline && "static" === lO.getStyle(o, "position", !0) && (o.style.position = "relative"),
        ...
        e.inline
          ...
          : ((e, t) => {
              ((e, t) => {
                ...
                t.editorContainer &&
                  ((t.editorContainer.style.display = e.orgDisplay), (e.hidden = vO.isHidden(t.editorContainer))),
    ...
    render() {
      ((e) => {
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) => Ms.forElement(e, { contentCssCors: Ed(t), referrerPolicy: ql(t) }))(
            o,
            e,
          )),
          pd(e)
        ...
        s &&
          ...
          hd(e) &&
            !Qo(e.getElement()) &&
            (kO.insertAfter(kO.create("input", { type: "hidden", name: t }), t), (e.hasHiddenInput = !0)),
    ...
    YT = {
      ...
      clamp: (e, t, n) => {
        ...
        const i = t.x + t.w,
          ...
          m = VT(0, a - l);
        return (
          (o += d), (r += c), n && ((s += d), (a += c), (o -= u), (r -= m)), (s -= u), (a -= m), GT(o, r, s - o, a - r)
        );
      },
      create: GT,
